...
class Venta
{
    ...
    public function cargarFormulario($request)
    {
        ...
        if (isset($request["txtFechaAnio"]) && isset($request["txtFechaMes"]) && isset($request["txtFechaDia"])) {
            $this->fecha = $request["txtFechaAnio"] . "-" . $request["txtFechaMes"] . "-" . $request["txtFechaDia"];
        }
